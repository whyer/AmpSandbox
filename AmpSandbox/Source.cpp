...
int main()
{
	...
	pick_accelerator();
	std::cout << "Begining calc" << std::endl;
	do_it();
	...
	std::cout << std::endl << "Hit return to exit..." << std::endl;
	std::cin.get();
}
...
void default_properties() {
	...
	std::wcout << "device name: " << default_acc.description << "\n";
	std::wcout << "device path: " << default_acc.device_path << "\n";
	std::wcout << "Dedicated memory: " << default_acc.dedicated_memory << "Mb" << "\n";
